...
public class ApoliceAniversarioService {
    private static final Logger logger = LoggerFactory.getLogger(ApoliceAniversarioService.class);
    ...
    public ApoliceAniversarioService(
